...
SPECS = [
    ...
    ('kr_exports', 'korea', '한국 수출 증가율(KOSIS)', '%', ['KOSIS_KR_EXPORTS'], 12, '1년 전 대비'),
...
FORMULAS = {
    ...
    'kr_exports': '(KOSIS 월별 수출액[t]/KOSIS 월별 수출액[t−12개월]−1)×100',
...
NOTES = {
    ...
    'kr_exports': '국가데이터처 KOSIS의 월별 수출 금액입니다. 명목 금액 기준이며 전년 동월 대비 증가율로 표시합니다.',
...
def calculate_base(raw):
    ...
    return {
        ...
        'kr_exports': yoy('KOSIS_KR_EXPORTS'),
