...
FREQUENCIES = {
    ...
    'PCEC96': 'monthly', 'PCENDC96': 'monthly',
    'PCEDGC96': 'monthly', 'PCESC96': 'monthly',
...
SPECS = [
    ...
    ('real_pce_nondurable', 'economy', '실질 비내구재 소비 증가율 (MoM)', '%', ['PCENDC96'], 1, '1개월 전 대비'),
    ('real_pce_durable', 'economy', '실질 내구재 소비 증가율 (MoM)', '%', ['PCEDGC96'], 1, '1개월 전 대비'),
    ('real_pce_services', 'economy', '실질 서비스 소비 증가율 (MoM)', '%', ['PCESC96'], 1, '1개월 전 대비'),
...
FORMULAS = {
    ...
    'real_pce': '(PCEC96[t]/PCEC96[t−1 month]−1)×100; BEA monthly real PCE, seasonally adjusted annual rate',
    'real_pce_nondurable': '(PCENDC96[t]/PCENDC96[t−1 month]−1)×100; BEA monthly real nondurable goods PCE',
...
NOTES = {
    ...
    'real_pce': 'BEA의 월별 실질 개인소비지출 수준을 전월과 비교한 증가율입니다. 물가 변동을 제거한 계절조정 연율 수준이며, 월간 증가율을 연율화하지 않았습니다.',
    'real_pce_nondurable': 'BEA의 월별 실질 비내구재 소비지출을 전월과 비교한 증가율입니다. 제조업 비내구재 수주와는 다른 소비 지표입니다.',
    'real_pce_durable': 'BEA의 월별 실질 내구재 소비지출을 전월과 비교한 증가율입니다. 제조업 내구재 수주와는 다른 소비 지표입니다.',
    'real_pce_services': 'BEA의 월별 실질 서비스 소비지출을 전월과 비교한 증가율입니다.',
...
def calculate_base(raw):
    ...
    return {
        ...
        'real_pce': mom('PCEC96'),
        'real_pce_nondurable': mom('PCENDC96'),
        'real_pce_durable': mom('PCEDGC96'),
        'real_pce_services': mom('PCESC96'),
        'durable': yoy('DGORDER'),
